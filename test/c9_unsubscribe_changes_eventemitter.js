describe(require('path').basename(__filename), function () {
  ...
  ['normal_bucket', 'strict_bucket'].forEach(function (bucketType) {
    ...
    context(bucketType, function () {
      ...
      it('should unsubscribe from an event', function (callback) {
        ...
        var path = '/' + bucketType + '/e2e_test1/testsubscribe/data/on_off_test';
      ...
      it('should unsubscribe from an event path', function (callback) {
        ...
        var path = '/' + bucketType + '/e2e_test1/testsubscribe/data/path_off_test';
      ...
      it('should unsubscribe from an event path using a wildcard', function (callback) {
        ...
        var path = '/' + bucketType + '/e2e_test1/testsubscribe/data/wildcard_path_off_test';
        ...
        listenerclient.on(path + '/*', {
          ...
          listenerclient.on(path + '/data/*', function (data) {
            ...
            listenerclient.offPath('/' + bucketType + '/e2e_test1/testsubscribe/data/wildcard*', function (e) {
      ...
      it('should unsubscribe from all events', function (callback) {
        ...
        var path = '/' + bucketType + '/e2e_test1/testsubscribe/data/off_all_test';
      ...
      it('should unsubscribe from only specific events with wildcard', function (callback) {
        ...
        Promise.all([
          ...
          .then(function () {
            return publisherclient.set('/' + bucketType + '/with/wildcard/unsubscribe/from/only/1', {});
          })
      ...
      it('should unsubscribe from only specific events without wildcard', function (callback) {
        ...
        var path = '/' + bucketType + '/without/wildcard/unsubscribe/from/only';
      ...
      it('should remove all subscriptions on offPath without wildcard', function (callback) {
        ...
        var path = '/' + bucketType + '/without/wildcard/off/path';
