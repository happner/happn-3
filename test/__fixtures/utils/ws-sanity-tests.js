...
SanityTests.prototype.run = function(server, publisherclient, listenerclient) {
    ...
    _this.listenerclient
      ...
      .then(function(eventId) {
        ...
        _this.publisherclient.set(
          "/1_eventemitter_embedded_sanity/" +
            _this.test_id +
            "/testsubscribe/data/onPublished/blah",
          {
            property1: "property1",
            property2: "property2",
            property3: "property3"
  ...
  it("the listener should pick up a wildcard event, no parameters", function(callback) {
    try {
      ...
      _this.listenerclient.on(
        "/2_websockets_embedded_sanity/" +
          _this.test_id +
          "/testsubscribe/data/anyevent/*",
        function(message) {
          expect(
            _this.listenerclient.events[
              "/ALL@/2_websockets_embedded_sanity/" +
                _this.test_id +
                "/testsubscribe/data/anyevent/*"
            ].length
          ).to.be(1);
        ...
        function(e) {
          if (!e) {
            ...
            _this.publisherclient.set(
              "/2_websockets_embedded_sanity/" +
                _this.test_id +
                "/testsubscribe/data/anyevent/blah",
              {
                property1: "property1",
                property2: "property2",
                property3: "property3"
    ...
    try {
      ...
      _this.listenerclient.on(
        ...
        function(message) {
          expect(
            _this.listenerclient.events[
              "/ALL@2_websockets_embedded_sanity/anyevent/*"
            ].length
          ).to.be(1);
          callback();
        },
    ...
    try {
      ...
      _this.listenerclient.on(
        ...
        function(message) {
          expect(
            _this.listenerclient.events[
              "/ALL@2_websockets_embedded_sanity/anyeventonce/*"
            ].length
          ).to.be(0);
          callback();
        },
    ...
    _this.listenerclient.on(
      ...
      function(err) {
        ...
        _this.publisherclient.set("setTest/object", object, {}, function(err) {
          expect(err).to.not.be.ok();
          _this.publisherclient.set("setTest/object", object, {}, function(
            err
          ) {
            expect(err).to.not.be.ok();
          });
  ...
  it("should tag some test data", function(callback) {
    ...
    _this.publisherclient.set(
      "/2_websockets_embedded_sanity/" + _this.test_id + "/test/tag",
      {
        property1: "property1",
        property2: "property2",
        property3: "property3"
      ...
      function(e, result) {
        ...
        _this.publisherclient.set(
          ...
          function(e, result) {
            ...
            _this.publisherclient.get(
              "/_TAGS/2_websockets_embedded_sanity/" +
                _this.test_id +
                "/test/tag/*",
              null,
              function(e, results) {
  ...
  it("the publisher should push a sibling and get all siblings", function(callback) {
    try {
      ...
      _this.publisherclient.setSibling(
        "2_websockets_embedded_sanity/" +
          _this.test_id +
          "/siblings/" +
          test_path_end,
      ...
      function(e, insertResult) {
        ...
        _this.publisherclient.set(
          ...
          function(e, insertResult) {
            ...
            _this.publisherclient.getPaths(
              "2_websockets_embedded_sanity/" +
                _this.test_id +
                "/testwildcard/" +
                test_path_end +
  ...
  it("will do events in the order they are passed", function(done) {
    ...
    _this.publisherclient.remove("/test_event_order", function(err) {
      ...
      setTimeout(function() {
        _this.publisherclient.get("/test_event_order", null, function(
          e,
          result
        ) {
