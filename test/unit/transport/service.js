describe(require('../../__fixtures/utils/test_helper').create().testName(__filename, 3), function () {
  ...
  function transportMock(createServerHttp, createServerHttps, fileExists){
    ...
    mockTransport.http = {
      createServer: createServerHttp || function(app){
        return {
          app: app
        };
      }
    ...
    mockTransport.https = {
      createServer: createServerHttps || function(options, app){
        return {
          app: app,
          options: options
        };
    ...
    mockTransport.happn = {
      services:{
        utils:{
          fileExists: fileExists || function(filePath){
            return true;
          }
        }
      }
  ...
  function fsMock(writeFileSync, readFileSync){
    return {
      writeFileSync: writeFileSync || function(){
        return {}
      },
