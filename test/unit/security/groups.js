    ...
    mockServices(function(e, happn) {
      ...
      happn.services.security.groups
        ...
        .then(function() {
          ...
          test.expect(happn.services.security.groups.__cache_permissions.keys().length).to.be(5);
          ...
          test.expect(happn.services.security.groups.__cache_permissions.keys().length).to.be(4);
          ...
          test.expect(happn.services.security.groups.__cache_permissions.keys().length).to.be(3);
          ...
          test.expect(happn.services.security.groups.__cache_permissions.keys().length).to.be(2);
          ...
          test.expect(happn.services.security.groups.__cache_permissions.keys().length).to.be(1);
          done();
        })
        .catch(done);
    });
