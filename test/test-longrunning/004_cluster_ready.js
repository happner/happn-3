describe('longrunning/004_cluster_ready', function() {
  ...
  ClusterChild.prototype.disconnectFrom = function(port, callback) {
    ...
    if (_this.connections[port]) {
      ...
      connection.randomActivity.generateActivityEnd(connection.code, function(
        aggregatedLog
      ) {
  ...
  ClusterChild.prototype.connectTo = function(child, callback) {
    ...
    happn_client.create(
      ...
      function(e, instance) {
        ...
        connection.randomActivity.generateActivityStart(
          connection.code,
          function(e) {
            if (e) return callback(e);
      ...
      function(e) {
        ...
        CLUSTER.stop(function(e) {
          ...
          aggregatedLogs.forEach(function(log) {
            ...
            aggregatedTotals.remove += log.initial.remove
              ? log.initial.remove
              : 0;
