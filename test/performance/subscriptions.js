...
describe(require('../__fixtures/utils/test_helper').create().testName(__filename, 3),  function () {
  ...
  it('creates ' + SUBSCRIPTION_COUNT + ' random paths, subscribes to each path, then loops through the paths and searches ' + SEARCH_COUNT + ' times in series, noPublish', function (done) {
