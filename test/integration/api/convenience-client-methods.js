describe(require('../../__fixtures/utils/test_helper').create().testName(__filename, 3), function () {
  ...
  it('increments a value on a path, convenience method, listens on path receives event: websockets', function (done) {
    ...
    eventemitterclient.on(test_base_url, function (data) {
  ...
  it('tests get paths: websockets', function (callback) {
    ...
    websocketsclient.set('e2e_test1/testwildcard/' + test_path_end, {
      property1: 'property1',
      property2: 'property2',
      property3: 'property3'
    }, null, function (e, insertResult) {
      expect(e == null).to.be(true);
      websocketsclient.set('e2e_test1/testwildcard/' + test_path_end + '/1', {
        property1: 'property1',
        property2: 'property2',
        property3: 'property3'
      }, null, function (e, insertResult) {
        ...
        websocketsclient.get('e2e_test1/testwildcard/' + test_path_end + '*', null, function (e, results) {

          expect(results.length == 2).to.be(true);
          expect(results[0].property1).to.be('property1');

          websocketsclient.getPaths('e2e_test1/testwildcard/' + test_path_end + '*', {}, function (e, results) {
  ...
  it('the publisher should push a sibling and get all siblings', function (callback) {
    ...
    try {
      ...
      websocketsclient.setSibling('e2e_test1/siblings/' + test_path_end, {
        ...
        websocketsclient.setSibling('e2e_test1/siblings/' + test_path_end, {
          ...
          websocketsclient.get('e2e_test1/siblings/' + test_path_end + '/*', null, function (e, getresults) {
            expect(e == null).to.be(true);
