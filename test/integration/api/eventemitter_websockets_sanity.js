      ...
      try {
        ...
        publisherclient.set(
          ...
          function(e, result) {
            ...
            if (!e) {
              publisherclient.get('e2e_test1/testsubscribe/data/' + test_path_end, null, function(
                e,
                results
              ) {
          ...
          function(e, results) {
            ...
            publisherclient.setSibling(
              ...
              function(e, results) {
                ...
                publisherclient.get('e2e_test1/siblings/' + test_path_end + '/*', null, function(
                  e,
                  getresults
                ) {
                  expect(e == null).to.be(true);
        ...
        function(e, insertResult) {
          ...
          publisherclient.set(
            ...
            function(e, insertResult) {
              ...
              publisherclient.get('e2e_test1/testwildcard/' + test_path_end + '*', null, function(
                e,
                results
              ) {
                expect(results.length == 2).to.be(true);

                publisherclient.getPaths('e2e_test1/testwildcard/' + test_path_end + '*', function(
                  e,
                  results
                ) {
                  expect(results.length == 2).to.be(true);
