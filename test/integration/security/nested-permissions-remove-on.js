...
describe(test.testName(__filename, 3), function() {
  ...
  let addedTestuser, addedTestuser2;
  ...
  before(
    ...
    async () => {
      ...
      await serviceInstance.services.security.users.linkGroup(addedTestGroup3, addedTestuser2);
      await serviceInstance.services.security.users.linkGroup(addedTestGroup4, addedTestuser2);
  ...
  context('get', () => {
    it.only('we romeve a duplicated permisison from one of the users groups, check user still has access', async () => {
  ...
  context.skip('events - changing permissions', function() {
