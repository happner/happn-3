describe(
  ...
  function() {
    ...
    it('should tag some test data', function(callback) {
      ...
      publisherclient.set(
        '/a2_eventemitter_embedded_paths/' + test_id + '/test/tag',
        {
          property1: 'property1',
          property2: 'property2',
          property3: 'property3'
        ...
        function(e, result) {
          ...
          publisherclient.set(
            ...
            function(e, result) {
              ...
              publisherclient.get(
                '/_TAGS/a2_eventemitter_embedded_paths/' + test_id + '/test/tag/*',
                null,
                function(e, results) {
                  expect(e).to.be(null);
    ...
    it('the publisher should push a sibling and get all siblings', function(callback) {
      ...
      try {
        ...
        publisherclient.setSibling(
          'a2_eventemitter_embedded_paths/' + test_id + '/siblings/' + test_path_end,
          {
