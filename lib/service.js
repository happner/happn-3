...
module.exports = {
  ...
  create: Promise.promisify(function (config, done) {
    ...
    happn.stop = Promise.promisify(function (options, stopCB) {
      ...
      //if not explicitly set to true ensure no reconnections
      //if (!options.reconnect) options.reconnect = false;
      //ACTUALLY NOT A GOOD IDEA, MEANS RESTARTS DON'T RECONNECT CLIENTS

      return services.stop(options, function (e) {
