...
AUTHORIZE_ACTIONS = ['get', 'set', 'on', 'remove'];
...
function __clearOnBehalfOfCache(config) {
...
function __initializeOnBehalfOfCache(config) {
...
function generateSession(user, sessionId, credentials) {
...
function __loginOK(credentials, user, sessionId, callback) {
  ...
  callback(null, this.generateSession(user, sessionId, credentials));
}
...
function __getOnBehalfOfSession(delegatedBy, onBehalfOf, callback){
  ...
  if (behalfOfSession) {
    //console.log('getSync:::', onBehalfOf, behalfOfSession.id, this.happn.services.system.name);
  ...
  this.users.getUser(onBehalfOf, (e, onBehalfOfUser) => {
    ...
    //console.log('__setOnBehalfOfSession:::', onBehalfOf);
    //console.log('setSync:::', onBehalfOf, behalfOfSession.id, this.happn.services.system.name);
