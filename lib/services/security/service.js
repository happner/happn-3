...
function processLogin(message, callback) {
  ...
  _this.login(credentials, sessionId, function (e, session) {
    ...
    if (attachedSession == null){
      console.log('attached session is null, here is session:::', session, _this.happn.services.system.name);
      console.log('current session keys:::', Object.keys(_this.happn.services.session.__sessions))
    }
