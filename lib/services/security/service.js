...
function SecurityService(opts) {
  ...
  this.securityDirectyChangedKey = null;
  this.securityDirectyChangedLocked = false;
  ...
  _this.securityDirectyChangedCheck = setInterval(function () {
    ...
    _this.dataService.get('/_SYSTEM/_SECURITY/DIRECTORY_CHANGED', function (e, changeKey) {
      ...
      if (changeKey && changeKey.data.value != _this.securityDirectyChangedKey) {
        ...
        if (this.securityDirectyChangedLocked == true) return;
...
SecurityService.prototype.lockLocalSecurityDirectory = function(){
  this.securityDirectyChangedLocked = true;
};

SecurityService.prototype.unlockLocalSecurityDirectory = function(){
  this.securityDirectyChangedLocked = false;
};
