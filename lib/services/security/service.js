        ...
        try {
          ...
          if (whatHappnd == 'delete-user') {
            ...
            if (sessionData.user.username == userName) {
              _this.sessionService.disconnectSession(sessionData.id, null, {
  ...
  _this.users.clearCaches()
    ...
    .then(function (effectedSessions) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (_this.happn.services.session)
          _this.happn.services.session.securityDirectoryChanged(whatHappnd, changedData, effectedSessions, additionalInfo)
            .then(function () {
              resolve(effectedSessions);
            })
            .catch(reject);
