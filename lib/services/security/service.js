...
SecurityService.prototype.setSecurityDirectyChangedKey = function () {
  ...
  return new Promise(function (resolve, reject) {
    ...
    _this.dataService.set('/_SYSTEM/_SECURITY/DIRECTORY_CHANGED', _this.securityDirectyChangedKey, function (e) {
...
SecurityService.prototype.dataChanged = function (updateDB) {
