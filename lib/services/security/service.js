...
SecurityService.prototype.__initializeSecurityDirectyChanged = function (config, callback) {
  ...
  _this.securityDirectyChangedCheck = setInterval(function () {
    ...
    _this.dataService.get('/_SYSTEM/_SECURITY/DIRECTORY_CHANGED', function (changeKey) {

      if (changeKey && changeKey.value != _this.securityDirectyChangedKey) {

        _this.securityDirectyChangedKey = changeKey;
