...
SecurityService.prototype.__initializeAuthProvider = __initializeAuthProvider;
...
SecurityService.prototype.checkTokenUserId = checkTokenUserId;
...
// Functions moved to Auth Provider
SecurityService.prototype.generateSession = generateSession;
SecurityService.prototype.login = login;
SecurityService.prototype.adminLogin = adminLogin;
...
async function initialize(config) {
  ...
  await this.__initializeAuthProvider(config);
}
...
function processLogin(message, callback) {
  ...
  this.authProvider.login(credentials, sessionId, message.request, (e, session) => {
...
function __initializeAuthProvider(config) {
  let authProviderName = config.authProvider || 'happn3-provider';
  this.authProvider = require(path.resolve(
    __dirname,
    `./authentication/${authProviderName}`
...
function generateSession(...sessionArgs) {
  return this.authProvider.generateSession(...sessionArgs);
}

function login(...loginArgs) {
  return this.authProvider.login(...loginArgs);
}
function adminLogin(...loginArgs) {
  return this.authProvider.adminLogin(...loginArgs);
}
function processUnsecureLogin(...loginArgs) {
  return this.authProvider.processUnsecureLogin(...loginArgs);
}
function __profileSession(...profileArgs) {
  return this.authProvider.__profileSession(...profileArgs);
}
// SecurityService.prototype.verifyAuthenticationDigest = verifyAuthenticationDigest;
function verifyAuthenticationDigest(...digestArgs) {
  return this.authProvider.verifyAuthenticationDigest(...digestArgs);
}
function __initializeProfiles(...initializeArgs) {
  return this.authProvider.__initializeProfiles(...initializeArgs);
}
