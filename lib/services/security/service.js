      ...
      if (credentials.token){
        ...
        try{
          ...
          return _this.authorize(previousSession, null, 'login', function(e){
            ...
            if (e) return _this.__loginFailed(credentials.username, 'invalid token', null, callback);

            _this.users.getUser(credentials.username, function (e, user) {

              if (user == null) return _this.__loginFailed(credentials.username, 'user does not exist', null, callback);
