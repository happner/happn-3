    ...
    this.sessionService.each(
      (sessionData, sessionCallback) => {
        ...
        if (
          ...
          if (sessionData.user.groups[changedData.groupName] != null || changedData.username === sessionData.user.username) effectedSessions.push(getEffectedSession(sessionData, true));
        }
