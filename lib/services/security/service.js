...
SecurityService.prototype.__initializeGroups = function (config) {
...
SecurityService.prototype.checkOverwrite = function (validationType, obj, path, name, options, callback) {
