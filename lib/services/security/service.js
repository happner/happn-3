...
SecurityService.prototype.clearCheckpointCaches = clearCheckpointCaches;
...
function clearCheckpointCaches(sessionId, permissionSetKey) {
  return this.checkpoint.clearCaches(
    [{ id: sessionId, previousPermissionSetKey: permissionSetKey }],
    true
  );
}
