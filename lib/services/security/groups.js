...
function __upsertGroup(group, options, callback) {
  ...
  _this.dataService.upsert(groupPath, group, function (e, result) {
...
function getGroup(groupName, options, callback) {
  ...
  _this.dataService.get('/_SYSTEM/_SECURITY/_GROUP/' + groupName, {
    sort: {
      'path': 1
    }
  }, function (e, result) {
    ...
    _this.__attachPermissions(group)
      .then(function (attached) {
        ...
        _this.__cache_groups.setSync(groupName, attached);
...
function linkGroup(group, user, options, callback) {
  ...
  _this.__validate('user-group', [group, user], options, function (e) {
    ...
    _this.dataService.upsert('/_SYSTEM/_SECURITY/_USER/' + user.username + '/_USER_GROUP/' + group.name, options, function (e, result) {
...
function listPermissions(groupName) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    _this.dataService.get('/_SYSTEM/_SECURITY/_PERMISSIONS/' + groupName + '/*', {
      sort: {
        'path': 1
      }
    }, function (e, results) {
