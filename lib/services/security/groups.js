...
SecurityGroups.prototype.initialize = Promise.promisify(function (config, securityService, callback) {
...
SecurityGroups.prototype.clearCaches = function () {

  return this.__cache_groups.clear();
};

SecurityGroups.prototype.__validate = function (validationType, options, obj, callback) {
...
SecurityGroups.prototype.__decodeGroupPermissions = function (group) {
...
SecurityGroups.prototype.__encodeGroupPermissions = function (group) {
...
SecurityGroups.prototype.__upsertGroup = function (group, options, callback) {
...
SecurityGroups.prototype.upsertGroup = function (group, options, callback) {
...
SecurityGroups.prototype.deleteGroup = function (group, options, callback) {
...
SecurityGroups.prototype.listGroups = function (groupName, options, callback) {
...
SecurityGroups.prototype.getGroup = function (groupName, options, callback) {
...
SecurityGroups.prototype.linkGroup = function (group, user, options, callback) {
...
SecurityGroups.prototype.unlinkGroup = function (group, user, options, callback) {
