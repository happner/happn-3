...
SecurityUsers.prototype.upsertUser = upsertUser;
SecurityUsers.prototype.__upsertUser = __upsertUser;
SecurityUsers.prototype.deleteUser = deleteUser;
SecurityUsers.prototype.__removeGroupLinks = __removeGroupLinks;
SecurityUsers.prototype.getUser = getUser;
SecurityUsers.prototype.listUsers = listUsers;
...
function __removeGroupLinks (userItems) {
  var usersList = [];
...
function listUsers (userName, options, callback) {
  ...
  try {
    ...
    _this.dataService.get(searchPath, {}, function (e, results) {
      ...
      var users = _this.__removeGroupLinks(results); //had to do this to be compatible with mongo

      callback(null, _this.securityService.serializeAll('user', users, options));
    });
