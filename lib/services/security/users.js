  ...
  this.dataService.get(searchPath, {
    ...
    results.forEach((userItem, userItemIndex) => {
      ...
      if (userItem.data && userItem.data.username) {
        if (userItem.data.username != userName) return;//ignore similar usernames due to wildcard
...
function listUserNamesByGroup(groupName){
  ...
  return new Promise((resolve, reject) => {
    ...
    this.dataService.get('/_SYSTEM/_SECURITY/_USER/*/_USER_GROUP/' + groupName, {path_only:true})
      .then(userGroupLinks => {
