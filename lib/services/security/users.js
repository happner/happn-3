...
SecurityUsers.prototype.clearCaches = function () {
...
SecurityUsers.prototype.__upsertUser = function (user, options, callback) {
  ...
  _this.__prepareUser(user, options, function (e, prepared) {
    ...
    _this.securityService.lockLocalSecurityDirectory();
    ...
    _this.dataService.upsert(userPath, prepared, {
      ...
      if (e) {
        _this.securityService.unlockLocalSecurityDirectory();
        return callback(e);
      }

      _this.securityService.dataChanged(false, function(){
  ...
  _this.dataService.remove(userPath, {}, function (e, result1) {
    ...
    _this.dataService.remove(userTree, {}, function (e, result2) {
      ...
      _this.__cache_users
        ...
        .then(function(){
          return _this.__cache_passwords.remove(user.username);
        })
        .then(function () {
...
SecurityUsers.prototype.__upsertGroup = function (group, options, callback) {
  ...
  _this.dataService.upsert(groupPath, group, {
    ...
    _this.securityService.dataChanged(true, function(){

      _this.securityService.unlockLocalSecurityDirectory();

      callback(null, _this.serialize('group', result));
    });
...
SecurityUsers.prototype.getUser = Promise.promisify(function (userName, options, callback) {
...
SecurityUsers.prototype.__removeGroupLinks = function (userItems) {
  ...
  for (var itemIndex in userItems) {
    ...
    if (userItem._meta['path'].indexOf('_USER_GROUP') >= 0) continue;
