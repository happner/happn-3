...
SecurityUsers.prototype.deleteUser = util.maybePromisify(deleteUser);
SecurityUsers.prototype.getUser = util.maybePromisify(getUser);
SecurityUsers.prototype.getUserNoGroups = require('util').callbackify(getUserNoGroups);
...
function __validate(validationType, options, obj, callback) {
  if (obj.name || obj.username) this.securityService.validateName(obj.name || obj.username, validationType);
