...
function PublicationService(opts) {

  this.log = opts.logger.createLogger('Publication');
...
util.inherits(PublicationService, EventEmitter);

PublicationService.prototype.stats = function (opts) {
  return {
...
PublicationService.prototype.processSubscribe = Promise.promisify(function(message, callback){
  try{
...
PublicationService.prototype.processUnsubscribe = Promise.promisify(function(message, callback){
  try{
...
PublicationService.prototype.processPublish = Promise.promisify(function(message, callback){
...
PublicationService.prototype.initialize = function (config, callback) {
  var _this = this;
...
PublicationService.prototype.__emitInitialValues = function (eventId, channel, sessionId, initialItems, protocol, callback) {
...
PublicationService.prototype.__doSubscriptionCallback = function (message, callback) {
  var _this = this;
...
PublicationService.prototype.addListener = function (channel, sessionId, parameters) {
...
PublicationService.prototype.decrementEventReference = function (audienceGroup, sessionId, channel, refCount) {
...
PublicationService.prototype.removeListener = function (sessionId, channel, parameters) {
  if (channel == '*') {
...
PublicationService.prototype.getAudienceGroup = function (channel, opts) {
...
PublicationService.prototype.__emitPublication = function (publication, channel, opts, sessionId, callback){
...
PublicationService.prototype.clearSubscriptions = function(sessionId){
  this.removeListener(sessionId, '*');
};

PublicationService.prototype.getAudienceSessions = function(sessions, opts){
...
PublicationService.prototype.emitToAudience = function (publication, channel, opts, callback) {
...
PublicationService.prototype.publish = function (request, payload, publishCallback) {
...
PublicationService.prototype.__notifyClient = function (socket, eventKey, data) {
