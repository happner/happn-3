...
LogService.prototype.write = Promise.promisify(function(message, type, data, area, severity){
  ...
  if (type == 'error'){
    ...
    if (typeof severity != 'number') logServerity = CONSTANTS.ERROR_SEVERITY.LOW;

    else logServerity = severity;

    message += ', severity: ' + logServerity.toString();
  }
