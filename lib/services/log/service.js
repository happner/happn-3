...
LogService.prototype.error = util.promisify(error);
LogService.prototype.info = util.promisify(info);
LogService.prototype.warn = util.promisify(warn);
LogService.prototype.write = util.promisify(write);
LogService.prototype.processMessage = util.promisify(processMessage);
