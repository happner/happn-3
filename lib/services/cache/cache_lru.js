...
LRUCache.prototype.set = util.promisify(set);
LRUCache.prototype.has = has;
LRUCache.prototype.get = util.promisify(get);
LRUCache.prototype.increment = util.promisify(increment);
LRUCache.prototype.update = util.promisify(update);
LRUCache.prototype.remove = util.promisify(remove);
LRUCache.prototype.clear = util.promisify(clear);
LRUCache.prototype.all = util.promisify(all);
