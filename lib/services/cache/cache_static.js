...
StaticCache.prototype.set = util.promisify(set);
StaticCache.prototype.get = util.promisify(get);
StaticCache.prototype.removeSync = removeSync;
StaticCache.prototype.setSync = setSync;
StaticCache.prototype.getSync = getSync;
StaticCache.prototype.increment = util.promisify(increment);
StaticCache.prototype.update = util.promisify(update);
StaticCache.prototype.remove = util.promisify(remove);
StaticCache.prototype.clear = util.promisify(clear);
StaticCache.prototype.stop = stop;
StaticCache.prototype.all = util.promisify(all);
...
StaticCache.prototype.__all = util.promisify(__all);
