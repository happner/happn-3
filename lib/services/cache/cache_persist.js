...
function PersistedCache(opts) {
  ...
  // this.setWithCallback = set.bind(this);
  // this.getWithCallback = get.bind(this);
  // this.incrementWithCallback = increment.bind(this);
  // this.updateWithCallback = update.bind(this);
  // this.removeWithCallback = remove.bind(this);
  // this.clearWithCallback = clear.bind(this);
  // this.allWithCallback = all.bind(this);
  // this.syncWithCallback = sync.bind(this);
}
