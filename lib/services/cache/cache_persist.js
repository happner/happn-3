...
PersistedCache.prototype.set = util.promisify(set);
PersistedCache.prototype.get = util.promisify(get);
PersistedCache.prototype.increment = util.promisify(increment);
PersistedCache.prototype.update = util.promisify(update);
PersistedCache.prototype.remove = util.promisify(remove);
PersistedCache.prototype.clear = util.promisify(clear);
PersistedCache.prototype.stop = stop;
PersistedCache.prototype.all = util.promisify(all);
PersistedCache.prototype.__returnAll = __returnAll;
PersistedCache.prototype.sync = util.promisify(sync);
