...
PublisherService.prototype.processPublish = function (message, callback) {
  ...
  try {
    ...
    return this.publishMessage(message, function (e) {
      ...
      if (e) {
        console.log('publish error:::', e.stack);
        return _this.errorService.handleSystem(new Error('processPublish failed', e), 'PublisherService', constants.ERROR_SEVERITY.MEDIUM, function (e) {
          callback(e, message);
        });
      }
