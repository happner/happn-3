...
PublisherService.prototype.processQueued = Promise.promisify(function(message, callback){

  try{

    return this.publish(message.request, message.response, message.recipients, this.CONSISTENCY.QUEUED, function(e){
      callback(e, message);
    });
