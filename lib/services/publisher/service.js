...
PublisherService.prototype.emitToAudience = function (publication, channel, opts, callback) {
...
PublisherService.prototype.publish = function (request, payload, recipients, consistency, publishCallback) {
  ...
  if (request.options) opts = _this.happn.services.utils.mergeObjects(opts, request.options, {overwrite:true, clone:true, consistency:consistency});
