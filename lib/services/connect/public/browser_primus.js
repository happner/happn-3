...
function Primus(url, options) {
  ...
  if (!options) console.log('OPTIONS NULL::: 1940');
  ...
  if (!options) console.log('options null::: 1977');
...
Primus.prototype.initialise = function initialise(options) {
  ...
  primus.on('incoming::error', function error(e) {
    ...
    if (connect) {
      ...
      if (!~primus.options) console.log('OPTIONS NULL::: 2310');
  ...
  primus.on('incoming::end', function end() {
    ...
    if (!~primus.options) console.log('OPTIONS NULL:::');
  ...
  primus.onlineHandler = function online() {
    ...
    if (!~primus.options) console.log('OPTIONS NULL 2439:::');
...
Primus.prototype.timeout = function timeout() {
  ...
  primus.timers.setTimeout('connect', function expired() {
    ...
    //
    if (!~primus.options) console.log('OPTIONS NULL::: 2755');
    if (~primus.options.strategy.indexOf('timeout')) {
      primus.recovery.reconnect();
    } else {
      primus.end();
