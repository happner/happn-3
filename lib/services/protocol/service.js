...
ProtocolService.prototype.__respondMessageIn = function(protocol, message, respond, e){
  ...
  try{
    ...
    protocol.success(message, respond);
  }catch(e){
...
ProtocolService.prototype.processMessageIn = function(message, callback){
  ...
  protocol.transformIn(message, function(e, transformed){
    ...
    if (e) return _this.__respondMessageIn(protocol, message, callback, e);
    ...
    return async.waterfall(
      ...
      _this.__respondMessageIn(protocol, transformed, callback, e);
      }
    );
  });
};
