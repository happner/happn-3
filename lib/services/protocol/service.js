...
ProtocolService.prototype.__updateProtocolStats = function(protocol, direction){
...
ProtocolService.prototype.initialize = Promise.promisify(function (config, callback) {
  ...
  this.__latest = require('./happn_' + require('../../../package.json').protocol).create();
  this.__earliest = require('./happn_1.1.0').create();
  ...
  if (!config.protocols['happn_1.3.0']) config.protocols['happn_1.3.0'] = require('./happn_1.3.0').create();
  if (!config.protocols['happn_1.2.0']) config.protocols['happn_1.2.0'] = require('./happn_1.2.0').create();
