...
ProtocolService.prototype.__respondMessageIn = function (protocol, message, respond, e) {
  ...
  try {
    ...
    this.happn.services.error.handleSystem(err, 'ProtocolService.__respondMessageIn', constants.ERROR_SEVERITY.MEDIUM);
  }
};
...
ProtocolService.prototype.__respondMessageInLayers = function (protocol, message, respond, e) {
  ...
  try {
    ...
    this.happn.services.error.handleSystem(err, 'ProtocolService.__respondMessageInLayers', constants.ERROR_SEVERITY.MEDIUM);
  }
};
...
ProtocolService.prototype.__getProtocol = function(sessionProtocol){
  ...
  if (sessionProtocol == 'happn' || sessionProtocol.indexOf('_') == -1) return this.config.protocols.happn_1;//old clients or new unconfigured sessions
