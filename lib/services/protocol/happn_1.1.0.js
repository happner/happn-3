...
ProtocolHappn.prototype.__createResponse = function (e, message, response, opts) {
  ...
  if (e) {
    ...
    if (typeof e === 'object') {
      ...
      if (e.message) response._meta.error.message =  e.message;//this is a non-iterable property

      else if (e.cause && e.cause.message) response._meta.error.message =  e.cause.message;
    }
