...
LayerService.prototype.initialize = function (config, callback) {
  ...
  try {
    ...
    this.__registerLayer('security');
    this.__registerLayer('pubsub');
    this.__registerLayer('log');
    this.__registerLayer('data', ['doStore', 'doNoStore', 'doGet', 'doRemove']);
    this.__registerLayer('session', ['configured']);
