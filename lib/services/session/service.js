...
SessionService.prototype.processDisconnect = function (message, callback) {
  ...
  try {
    ...
    _this.__queuedDisconnects.set(message.session.id, message.request.options, {ttl: _this.config.queuedDisconnectsTTL}, function (e) {
...
SessionService.prototype.initialize = function (config, callback) {
  ...
  try {
    ...
    if (_this.config.primusEvents){
      for (var eventKey in _this.config.primusEvents)
        _this.primus.on(eventKey, _this.config.primusEvents[eventKey])
    }

    console.log(_this.config.primusEvents);
...
SessionService.prototype.handleMessage = Promise.promisify(function (message, client) {
  ...
  _this.happn.services.queue.pushInbound({
    ...
    .catch(function(e){
      _this.happn.services.error.handleSystem.bind(_this.happn.services.error)(e, 'SessionService.handleMessage', constants.ERROR_SEVERITY.MEDIUM);
    });
...
SessionService.prototype.__finalizeDisconnect = function (client, options, callback) {
  ...
  _this.happn.services.subscription.clearSubscriptions(client.sessionId, function (e) {
    ...
    _this.__possiblyRevokeSession(client, options, function (e) {
      ...
      _this.happn.services.queue.pushSystem({action: 'disconnect', options: options, session: sessionData})
        ...
        .catch(function(e){
          _this.happn.services.error.handleSystem.bind(_this.happn.services.error)(e, 'SessionService.__finalizeDisconnect', constants.ERROR_SEVERITY.MEDIUM);
        });
