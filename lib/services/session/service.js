...
SessionService.prototype.handleMessage = Promise.promisify(function (message, client) {
  ...
  _this.happn.services.queue.pushInbound({
    ...
    .catch(function(e){
      _this.happn.services.error.handleSystem.bind(_this.happn.services.error)(e, 'SessionService', constants.ERROR_SEVERITY.MEDIUM);
    });
...
SessionService.prototype.__finalizeDisconnect = function (client, options, callback) {
  ...
  _this.happn.services.subscription.clearSubscriptions(client.sessionId, function (e) {
    ...
    if (e)  _this.happn.services.error.handleSystem(e, 'SessionService', constants.ERROR_SEVERITY.LOW);//handle an error but continue nevertheless
    ...
    _this.__possiblyRevokeSession(client, options, function (e) {
      ...
      if (e) {
        ...
        return _this.errorService.handleSystem(e, 'SessionService', constants.ERROR_SEVERITY.HIGH);
      }
      ...
      _this.happn.services.queue.pushSystem({action: 'disconnect', options: options, session: sessionData})
        ...
        .then(function (processed) {
          ...
          try {
            ...
            _this.happn.services.error.handleSystem(e, 'SessionService', constants.ERROR_SEVERITY.MEDIUM);
          }
        })
