...
SessionService.prototype.processDisconnect = Promise.promisify(function(message, callback) {
...
SessionService.prototype.processConfigureSession = Promise.promisify(function(message, callback) {
...
SessionService.prototype.__finalizeDisconnect = function(client, options, callback) {
  ...
  _this.happn.services.subscription.clearSessionSubscriptions(client.sessionId);
