...
SessionService.prototype.__getClientUpgradeHeaders = __getClientUpgradeHeaders;
...
function __getClientUpgradeHeaders(headers) {
  if (!headers) return {};
...
function onConnect(client) {
  ...
  this.__sessions[client.sessionId] = {
    ...
    data: {
      ...
      headers: this.__getClientUpgradeHeaders(client.headers),
