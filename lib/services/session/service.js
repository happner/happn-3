...
SessionService.prototype.localClient = util.promisify(localClient);
SessionService.prototype.localAdminClient = util.promisify(localAdminClient);
SessionService.prototype.__configureSession = util.promisify(__configureSession);
...
SessionService.prototype.__clearSecurityCache = __clearSecurityCache;
...
function __clearSecurityCache(sessionId, permissionSetKey) {
  this.happn.services.security.clearCheckpointCaches(sessionId, permissionSetKey);
}
...
function finalizeDisconnect(client, callback) {
  try {
    ...
    this.__clearSecurityCache(sessionData.id, sessionData.permissionSetKey);
