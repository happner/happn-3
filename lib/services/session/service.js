...
SessionService.prototype.onConnect = function (client) {
  ...
  //readyStateChange
  // client.on('readyStateChange', function (message) {
  //   console.log('readyStateChanged:::', client.__readyState);
  //   _this.__sessions[client.sessionId].state = message;
  // });

  _this.__sessions[client.sessionId].data = {
    id: client.sessionId,
    protocol:'happn_' + '1.1.0',//we default to the oldest protocol
