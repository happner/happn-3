...
function StrictBucket(options) {
  ...
  //we dont want to set the action property continually
  options.subscriptionTree.appendSubscriptionProperties = {
...
StrictBucket.prototype.initialize = function (callback) {
  ...
  try {
    ...
    Object.defineProperty(this, '__subscriptions', {
      value: new SubscriptionTree(this.options.subscriptionTree)
    });
