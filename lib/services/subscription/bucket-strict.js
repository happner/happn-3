...
function StrictBucket(options) {
  ...
  if (!options.channel) throw new Error('StrictBucket must be for a specified channel');

  if (!options.name) throw new Error('StrictBucket must have a name');
...
StrictBucket.prototype.__removableNodeTrie = function (keyProp) {
...
StrictBucket.prototype.wildcardMatch = function (pattern, matchTo) {
...
StrictBucket.prototype.__getItemsForSegment = function (path, sortedArray, matchesCriteria, options) {
...
StrictBucket.prototype.__getExplicitSubscriptions = function (path) {
...
StrictBucket.prototype.__searchSubscriptions = function (segment, options) {
...
StrictBucket.prototype.__getSegments = function (path) {
...
StrictBucket.prototype.__removeExplicitSubscription = function (path, sessionId, options, callback) {
...
StrictBucket.prototype.__addExplicitSubscription = function (path, sessionId, data, callback) {
...
StrictBucket.prototype.__updateSegment = function (path) {
...
StrictBucket.prototype.addSubscription = function (path, sessionId, data, callback) {
  ...
  };//in case we have a StrictBucket that needs a callback
...
StrictBucket.prototype.__removeSegment = function (path) {
