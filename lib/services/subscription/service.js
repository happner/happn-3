...
SubscriptionService.prototype.processUnsubscribe = function (message, callback) {
  ...
  try {
    ...
    this.removeListener(message.session.id, message.request.path, message.request.key, {options:message.request.options, eventId:message.request.eventId}, function (e) {
...
SubscriptionService.prototype.removeListener = function (sessionId, channel, key, parameters, callback) {
  ...
  bucket.removeSubscription(key, sessionId, callback);
};
