...
SubscriptionService.prototype.allListeners = function (sessionId) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    _this.subscriptions['all'].searchAsync({path: '*', key: sessionId})
      .then(function (references) {
        references.forEach(function(reference){
          reference.action = 'all';
          allListeners.push(reference);
        });
        return _this.subscriptions['set'].searchAsync({path: '*', key: sessionId})
      })
      .then(function (references) {
        references.forEach(function(reference){
        ...
        return _this.subscriptions['remove'].searchAsync({path: '*', key: sessionId})
      })
      .then(function (references) {
        references.forEach(function(reference){
