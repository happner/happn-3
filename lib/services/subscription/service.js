...
SubscriptionService.prototype.securityDirectoryChanged = function (whatHappnd, changedData, effectedSessions) {
  ...
  //TODO: loop through subscriptions and remove those that conflict with permissions if what happened
  // is the unlinking/deleting of a group or user or change of a permission

  //console.log('subscriptions securityDirectoryChanged:::', whatHappnd, changedData, effectedSessions);
