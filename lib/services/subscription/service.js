...
SubscriptionService.prototype.getSubscriptionPath = function(action, path){
...
SubscriptionService.prototype.prepareSubscribeMessage = function(message) {
...
SubscriptionService.prototype.processUnsubscribe = function(message) {

  var _this = this;

  return new Promise(function(resolve, reject){
    try {
      console.log('processUnsubscribe message.request:::', message.request);
...
SubscriptionService.prototype.__filterTargetRecipients = function(targetClients, recipients) {
...
SubscriptionService.prototype.getRecipients = function(message) {
