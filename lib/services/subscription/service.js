...
SubscriptionService.prototype.securityDirectoryChanged = function (whatHappnd, changedData, effectedSessions) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (effectedSessions == null || effectedSessions.length == 0 || ['permission-removed', 'permission-upserted', 'unlink-group', 'delete-group', 'upsert-group'].indexOf(whatHappnd) == -1) return resolve(effectedSessions);
