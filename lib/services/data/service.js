...
DataService.prototype.__upsertInternal = function (path, setData, options, dataWasMerged, callback) {
  ...
  if (options.increment != null) {
    ...
    return provider.increment(path, setData.data.value, options.increment, function(e, guageValue){

      if (e) return callback(e);

      setData.data.guage = setData.data.value;
      setData.data.value = guageValue;
