...
function parseFields(fields) {
  ...
  // JCE: @southbite could you explain this please, I can't see how an unreferenced variable affects anything
...
function __getPullOptions(path, parameters) {
  ...
  if (parameters) {
    ...
    if (parameters.fields || parameters.options.fields) {
      returnParams.options.fields = this.parseFields(
        parameters.options.fields || parameters.fields
      );
