...
function NedbService(opts) {

  var Logger;

  if (opts && opts.logger) {
    Logger = opts.logger.createLogger('Nedb');
  } else {
    Logger = require('happn-logger');
    Logger.configure({logLevel: 'info'});
  }

  this.log = Logger.createLogger('Nedb');
  this.log.$$TRACE('construct(%j)', opts);
}

NedbService.prototype.pathField = "_id";

NedbService.prototype.stop = function (options, callback) {
...
NedbService.prototype.doGet = Promise.promisify(function(message, callback){
...
NedbService.prototype.doRemove = Promise.promisify(function(message, callback){
...
NedbService.prototype.doStore = Promise.promisify(function(message, callback){
...
NedbService.prototype.doSecureStore = Promise.promisify(function(message, callback){
...
NedbService.prototype.doNoStore = Promise.promisify(function(message, callback){
...
NedbService.prototype.initialize = function (config, callback) {
...
NedbService.prototype.__compacting = {};
NedbService.prototype.startCompacting = function (dataStoreKey, interval, callback, compactionHandler) {
  try {
...
NedbService.prototype.stopCompacting = function (dataStoreKey, callback) {
  var _this = this;
...
NedbService.prototype.__compact = function (ds, callback) {
...
NedbService.prototype.__iterateDataStores = function (dataStoreKey, operator, callback) {
  var _this = this;
...
NedbService.prototype.compact = function (dataStoreKey, callback) {
...
NedbService.prototype.addDataStoreFilter = function (pattern, datastoreKey) {
...
NedbService.prototype.removeDataStoreFilter = function (pattern) {
...
NedbService.prototype.getOneByPath = function (path, fields, callback) {
...
NedbService.prototype.randomId = function(){
  return Date.now() + '_' + uuid.v4().replace(/-/g, '');
};

NedbService.prototype.insertTag = function(snapshotData, tag, path, callback){
...
NedbService.prototype.saveTag = function (path, tag, data, callback) {
...
NedbService.prototype.parseFields = function (fields) {
...
NedbService.prototype.get = function (path, parameters, callback) {
...
NedbService.prototype.formatSetData = function (path, data, options) {
...
NedbService.prototype.upsert = function (path, data, options, callback) {
...
NedbService.prototype.transform = function (dataObj, meta) {
...
NedbService.prototype.transformAll = function (items) {
...
NedbService.prototype.__upsertInternal = function (path, setData, options, dataWasMerged, callback) {
...
NedbService.prototype.getPathCriteria = function(path){
...
NedbService.prototype.remove = function (path, options, callback) {
