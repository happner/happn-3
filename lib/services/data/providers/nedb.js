...
NedbProvider.prototype.escapeRegex = function (str) {
...
NedbProvider.prototype.preparePath = function (path) {
...
NedbProvider.prototype.getPathCriteria = function (path) {
  ...
  if (returnType > -1) {
    ...
    pathCriteria.$and.push({'_id': {$regex: new RegExp(searchPath)}});//keys with any prefix ie. */joe/bloggs
