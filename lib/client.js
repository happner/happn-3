...
(function() {
  ...
  HappnClient.prototype.__reattachChangedListeners = function(permissions) {
    ...
    // let listenerProhibitPaths = Object.keys(permissions).filter(
    //   key =>
    //     permissions[key].prohibit &&
    //     (permissions[key].prohibit.includes('*') || permissions[key].prohibit.includes('on'))
    // );
    // DO SOMETHING WITH PROHIBITIONS
