...
(function() {
  ...
  HappnClient.prototype.__writeCookie = function(session, sessionDocument) {
    var cookieName = session.cookieName || 'happn_token';
    if (this.options.protocol === 'https' && session.httpsCookie) cookieName += '_https';
    var cookie = cookieName + '=' + session.token + '; path=/;';
