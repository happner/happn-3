(function () { // begin enclosed
  ...
  HappnClient.prototype.__requestCallback = function(message, callback, options, eventId, path){
  ...
  HappnClient.prototype.__performDataRequest = function (path, action, data, options, callback) {
    ...
    if (callback) this.__requestCallback(message, callback, options, eventId, path);// if null we are firing and forgetting
