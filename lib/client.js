(function () { // begin enclosed
  ...
  HappnClient.prototype.increment = Promisify(function (path, guage, increment, handler) {
    ...
    this.set(path, guage, {increment: increment}, handler);
  });
  ...
  HappnClient.prototype.reconnect = function (options) {
    ...
    if (_this.session) console.log('reconnected session:::', _this.session);
