(function () { // begin enclosed
  ...
  HappnClient.prototype.__connectSocket = function (callback) {
    ...
    socket.on('timeout', function () {
      ...
      _this.handle_error(new Error('connection timed out'), 3);
    });
      ...
      function (attempt, next) {
        ...
        login(function (e) {
          ...
          if (e) {
            ...
            if (e.code && e.code == 403 || e.code == 401) return next(e); //access was denied
  ...
  HappnClient.prototype.handle_reconnect_scheduled = function (opts) {
    ...
    if (_this.options.pool) { //we have options
      ...
      _this.reconnect(function (e) {
        ...
        if (e) _this.handle_error(new Error('pooled subscription reconnection failed', e), 3);
      });
    }
  };
  ...
  HappnClient.prototype.handle_error = function (err, severity) {
    ...
    if (severity > 1) this.state = STATE.ERROR;//prevents any further client calls going through
  };
