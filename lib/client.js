(function() { // begin enclosed
  ...
  HappnClient.prototype.__connectSocket = function(callback) {
    ...
    socket.on('error', function(e) {
      ...
      socketError.code = e.error.code;
      socketError.errno = e.error.errno;
      socketError.syscall = e.error.syscall;
      socketError.address = e.error.address;
      socketError.port = e.error.port;
      ...
      _this.handle_error(socketError);
    });
    ...
    _this.utils.async(Object.keys(_this.state.events), function(eventPath, index, nextEvent) {
      ...
      _this.utils.async(listeners, function(listener, index, nextListener) {
        ...
        _this._offPath(eventPath, function(e) {
          ...
          if (e) return nextListener(new Error('failed detaching listener to path, on re-establishment: ' + eventPath, e));
